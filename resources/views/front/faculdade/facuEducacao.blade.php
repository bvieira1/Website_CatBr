...
@section('content')
    <div class="course-page">
                ...
                <div class="content-details">
                    ...
                    <div class="detail-section ">
                        <div class="section-carousel owl-carousel owl-theme ">
                            ...
                            <div class="item ">
                                <img class="section-responsive-image " src="{{ url( 'front/faculdade/assets/images/material-02.png') }} " alt="Material didático ">
                            ...
                            <div class="item ">
                                <img class="section-responsive-image " src="{{ url( 'front/faculdade/assets/images/material-03.png') }} " alt="Material didático ">
                                <div class="text ">Para cada capítulo do livro, há uma videoaula correspondente</div>
                            </div>
                            <div class="item ">
                                <img class="section-responsive-image " src="{{ url( 'front/faculdade/assets/images/material-04.png') }} " alt="Material didático ">
                            ...
                            <div class="item ">
                                <img class="section-responsive-image " src="{{ url( 'front/faculdade/assets/images/material-05.png') }} " alt="AVA - Ambiente Virtual de Aprendizagem ">
        ...
        <div class="section share ">
            ...
            <a class="btn-share icon-facebook " href="https://www.facebook.com/sharer/sharer.php?u=https://ead.unilins.edu.br/pos-graduacao-em-administracao-escolar-a-distancia-ead/519&amp;title=ADMINISTRAÇÃO ESCOLAR&amp;description=Tudo o que você precisa:
    o melhor em livros e DVDs à preços imbatíveis! ">Compartilhar</a>
        </div>
    </div>
