        ...
        <div class="page-contents">
            <div class="content-details">
                <h1 id="product-title" class="detail-title">
                    ...
                    <strong class="title-size-small"> {{ $bacha->titleSecond }} <span>{{ $bacha->third }}</span></strong>
                </h1>
                ...
                <div class="detail-section">
                    ...
                    <div class="video-responsive">
                        <iframe src="{{ url( $bacha->video ) }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                        </iframe>
                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="become-teacher__form">
                                                            ...
                                                            <form action="{{ route('facuMatricula') }}" method="post" autocomplete="off" class="become-teacher__form-content">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="text" id="course" name="course" class="form-control {{ ($errors->has('course') ? 'is-invalid' : '') }}" value="{{ $bacha->titleSecond }} em 48 meses" placeholder="Assunto" required >
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="become-teacher__form">
                                                        ...
                                                        <form action="{{ route('facuMatricula') }}" method="post" autocomplete="off" class="become-teacher__form-content">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" id="course" name="course" class="form-control {{ ($errors->has('course') ? 'is-invalid' : '') }}" value="{{ $bacha->titleSecond }} em 64 meses" placeholder="Assunto" required >
                                                                @if($errors->has('course'))
                                                                    <div class="invalid-feedback">
                                                                        {{ $errors->first('course') }}
                                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="become-teacher__form">
                                                        ...
                                                        <form action="{{ route('facuMatricula') }}" method="post" autocomplete="off" class="become-teacher__form-content">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" id="course" name="course" class="form-control title_course{{ ($errors->has('course') ? 'is-invalid' : '') }}" value="{{ $bacha->titleSecond }} em 64 meses" placeholder="Assunto" required >
                                                                @if($errors->has('course'))
                                                                    <div class="invalid-feedback">
                                                                        {{ $errors->first('course') }}
                                                                    </div>
